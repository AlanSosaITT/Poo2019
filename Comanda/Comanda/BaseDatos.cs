...
namespace Comanda
{
    class BaseDatos
    {
        ...
        {
            //El error aqui se encuentra en que el momento de llamar a la lista, pediamos la lista <T>, siendo que no echizte dicha clase "T", entonces le mandabamos la deseada.
            listamenu = new List<Menu>
            {
            ...
            //En vez de llamar a la lsita de ensaladas llamabamos a la lista de Menu
